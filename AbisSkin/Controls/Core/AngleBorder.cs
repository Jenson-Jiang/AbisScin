using AbisSkin.Controls.Tools.Extension;
using System;
    ...
    public class AngleBorder : Decorator
    {
        ...
        protected override void OnRender(DrawingContext drawingContext)
        {
            if (Child != null)
            {
                ...
                pen.Thickness = UIElementExtension.RoundLayoutValue(BorderThickness.Left, DoubleUtils.DpiScaleX);
    ...
    public static class UlementEx
    {
        public static double RoundLayoutValue(double value, double dpiScale)
        {
            ...
            if (!DoubleUtils.AreClose(dpiScale, 1.0))
            {
                ...
                if (DoubleUtils.IsNaN(num) || double.IsInfinity(num) || DoubleUtils.AreClose(num, 1.7976931348623157E+308))
                {
                    num = value;
                }
            }
