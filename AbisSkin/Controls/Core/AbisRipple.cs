...
namespace AbisSkin.Controls.Core
{
    ...
    public class AbisRipple : ContentControl
    {
        ...
        private static readonly HashSet<AbisRipple> PressedInstances = new HashSet<AbisRipple>();

        static AbisRipple()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(AbisRipple), new FrameworkPropertyMetadata(typeof(AbisRipple)));
        ...
        public static readonly DependencyProperty FeedbackProperty = DependencyProperty.Register(
            nameof(Feedback), typeof(Brush), typeof(AbisRipple), new PropertyMetadata(default(Brush)));
        ...
        private static readonly DependencyPropertyKey RippleSizePropertyKey =
            DependencyProperty.RegisterReadOnly(
                "RippleSize", typeof(double), typeof(AbisRipple),
        ...
        private static readonly DependencyPropertyKey RippleXPropertyKey =
            DependencyProperty.RegisterReadOnly(
                "RippleX", typeof(double), typeof(AbisRipple),
                new PropertyMetadata(default(double)));
        ...
        private static readonly DependencyPropertyKey RippleYPropertyKey =
            DependencyProperty.RegisterReadOnly(
                "RippleY", typeof(double), typeof(AbisRipple),
                new PropertyMetadata(default(double)));
        ...
        {
            if (AbisRippleAssist.GetIsCentered(this))
            {
            ...
            if (!AbisRippleAssist.GetIsDisabled(this))
            {
        ...
        private static readonly DependencyPropertyKey AduRippleSizePropertyKey =
            DependencyProperty.RegisterReadOnly(
                "AduRippleSize", typeof(double), typeof(AbisRipple),
                new PropertyMetadata(default(double)));
        ...
        private static readonly DependencyPropertyKey AduRippleXPropertyKey =
            DependencyProperty.RegisterReadOnly(
                "AduRippleX", typeof(double), typeof(AbisRipple),
                new PropertyMetadata(default(double)));
        ...
        private static readonly DependencyPropertyKey AduRippleYPropertyKey =
            DependencyProperty.RegisterReadOnly(
                "AduRippleY", typeof(double), typeof(AbisRipple),
                new PropertyMetadata(default(double)));
        ...
        public static readonly DependencyProperty RecognizesAccessKeyProperty =
            DependencyProperty.Register(
                nameof(RecognizesAccessKey), typeof(bool), typeof(AbisRipple),
        ...
        private void OnSizeChanged(object sender, SizeChangedEventArgs sizeChangedEventArgs)
        {
            ...
            if (AbisRippleAssist.GetIsCentered(this) && innerContent != null)
            {
            ...
            AduRippleSize = 2 * radius * AbisRippleAssist.GetRippleSizeMultiplier(this);
        }
    }
}
