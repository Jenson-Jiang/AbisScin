...
using AbisSkin.Controls;
using AbisSkin.Controls.Expression.Drawing;

namespace AbisSkin.Controls.Tools.Extension
{
    public static class GeometryExtension
    {
        ...
        public static double GetTotalLength(this Geometry geometry, Size size, double strokeThickness = 1)
        {
            ...
            if (MathUtils.IsVerySmall(size.Width) || MathUtils.IsVerySmall(size.Height)) return 0;
            ...
            if (MathUtils.IsVerySmall(min) || MathUtils.IsVerySmall(strokeThickness)) return 0;
