...
namespace AbisSkin.Controls.Expression.Drawing
{
    public static class GeometryUtils
    {
        ...
        {
            return new Point(
                MathUtils.Lerp(pointA.X, pointB.X, alpha),
                MathUtils.Lerp(pointA.Y, pointB.Y, alpha));
        }

        internal static Vector Lerp(Vector vectorA, Vector vectorB, double alpha)
        {
            return new Vector(MathUtils.Lerp(vectorA.X, vectorB.X, alpha),
                MathUtils.Lerp(vectorA.Y, vectorB.Y, alpha));
        }
        ...
        internal static Vector Normalized(this Vector vector)
        {
            ...
            if (MathUtils.IsVerySmall(length)) return new Vector(0.0, 1.0);
